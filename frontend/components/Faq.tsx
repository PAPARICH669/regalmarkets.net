...
const ITEMS = [
  { q: "How does the 200% Commission work?", a: "Every investment package returns 200% of your principal. Commission is paid daily (default 1%/day) into your E-WALLET until the package reaches 200% total, then it completes automatically." },
  { q: "What is the matching bonus?", a: "An unlimited-level override on your downline's daily Commission. Each upline earns the difference between their rank percentage and the highest already paid below them. Same-rank uplines stop the rollup." },
